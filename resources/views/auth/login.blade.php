        ...
        <aside>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    ...
                    <span class="input">
                        <input class="input_field @error('password') is-invalid @enderror" type="password"
                ...
                <div class="text-center add_top_10">New to the platform? <strong><a href="/register">Sign
                            up!</a></strong></div>
            </form>
